defmodule LiveviewStreamsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveviewStreamsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveviewStreamsWeb.Gettext, "errors", msg, opts)
    end
  end
